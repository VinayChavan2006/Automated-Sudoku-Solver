...
1.  Recall Problem 4 from Worksheet 3, where the task wasto obtain the average number of attempts it takes to blow out the candles on my 25th birthday:
...
Now that you've learned benchmarking a little bit, we will learn about coding efficiently in R.
